  ...
  return (
    <div className="card w-full overflow-hidden" aria-hidden>
      <div className="flex flex-col gap-4 p-4 sm:flex-row sm:p-5">
        <div className="aspect-video w-full shrink-0 animate-pulse rounded-xl bg-white/[0.05] sm:w-56" />
        <div className="flex min-w-0 flex-1 flex-col gap-3 py-1">
          <div className="h-4 w-3/4 animate-pulse rounded-md bg-white/[0.06]" />
          <div className="h-4 w-1/2 animate-pulse rounded-md bg-white/[0.05]" />
          <div className="h-3 w-1/3 animate-pulse rounded-md bg-white/[0.04]" />
      ...
      <div className="grid gap-2 border-t border-white/[0.06] p-4 sm:grid-cols-2 sm:p-5">

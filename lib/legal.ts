  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        heading: "Analytics",
        body: [
          "We run two analytics tools, and they have different privacy characteristics, so it is worth separating them. Both receive page views and the download steps described below. Vercel Analytics sets no cookies and does not identify you. Google Analytics 4 does set first-party cookies (named _ga and _ga_ followed by the stream id) and sends what it collects to Google, who process it under their own terms. Google receives your IP address in order to derive an approximate location, and discards it after that.",
